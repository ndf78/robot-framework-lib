...
def lister_dossier_fichier(chemin):  # Indique le "chemin" comme dans l'exemple suivant : C:\\Users\\hdf-msi\\Robot Framework\\Robot Excel\\lapin
    list_dossier_fichier = os.listdir(chemin)
    msg = list_dossier_fichier
    resultat_log = print(msg)
    return resultat_log

def rechercher_liste_dossier_fichier(chemin, rechercher):  # Indique le "chemin" comme dans l'exemple suivant : C:\\Users\\hdf-msi\\Robot Framework\\Robot Excel\\lapin
    list_dossier_fichier = os.listdir(chemin)
...
def rechercher_un_dossier_fichier(chemin, rechercher):  # Indique le "chemin" comme dans l'exemple suivant : C:\\Users\\hdf-msi\\Robot Framework\\Robot Excel\\lapin
    list_dossier_fichier = os.listdir(chemin)
    filtre1 = [x for x in list_dossier_fichier if x.startswith(rechercher)]
    msg = filtre1[0]
    resultat_log = print(msg)
